...
public class Stock implements Quarters {
    private String name;
    private String address;
    private double area;
    private int quantityRack; // количество стеллажей
    private int[] quantityShelf; // количество полок в стелаже

    public Stock() {
    }

    public Stock(String name, String address,double area,int quantityRack,int[] quantityShelf ) {
        this.name = name;
    ...
    public QuartersDTO getCountRackWithQuantityShelf(int countShelf){
       // for (int shelf : )
        return null;
    }
